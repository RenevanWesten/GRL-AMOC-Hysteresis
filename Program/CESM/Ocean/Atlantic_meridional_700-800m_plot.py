#Program plots the Atlantic meridional profiles between 700 - 800 m depths
...
ax.plot([4400-4168, 4400-4168], [6, 100], '--k', linewidth = 2.0)
ax.text(4400-4168, 5.05, 'AMOC$_{\mathrm{max}}$', verticalalignment='bottom', horizontalalignment='center', color = 'k', fontsize=12)
...
ax.set_title('Temperature (700 - 800 m) at 30$^{\circ}$N')
...
ax.set_title('Salinity (700 - 800 m) at 30$^{\circ}$N')
...
ax.plot([4400-4168, 4400-4168], [0.07, 100], '--k', linewidth = 2.0)
ax.text(4400-4168, 0.01, 'AMOC$_{\mathrm{max}}$', verticalalignment='bottom', horizontalalignment='center', color = 'k', fontsize=12)
...
ax.set_title('f) Potential density (700 - 800 m) difference (north minus south)')
...
ax.set_title('Temperature (700 - 800 m)')
...
ax.set_title('Salinity (700 - 800 m)')
#-----------------------------------------------------------------------------------------
...
ax.set_title('e) Potential density (700 - 800 m)')
